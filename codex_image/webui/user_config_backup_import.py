...
from .user_config_restore_types import (
...
from .user_config_backup_validation import (
    UserConfigArchiveValidator,
...
class UserConfigBackupImportService:
    def _archive_validator(self) -> UserConfigArchiveValidator:
        return UserConfigArchiveValidator(
    ...
    def _extract_member(
        ...
        return self._archive_validator()._extract_member(archive, info, staging, expected_size, expected_sha256)
    ...
    def _validate_semantics(
        ...
        return self._archive_validator()._validate_semantics(manifest, staging)

    def _validate_chips(self, payloads: dict[str, Any]) -> None:
        return self._archive_validator()._validate_chips(payloads)
    ...
    def _validate_gallery(
        ...
        return self._archive_validator()._validate_gallery(manifest, staging, payloads)
    ...
    def _validate_templates(
        ...
        return self._archive_validator()._validate_templates(manifest, staging, payloads)
    ...
    def _validate_settings(
        ...
        return self._archive_validator()._validate_settings(manifest, payloads)
