...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-769", index)
        self.assertIn("runtime-769", history)
        self.assertIn("history-110", history)
        self.assertIn('ilab-conjure-shell-v246', worker)
        self.assertIn('/static/app.js?v=runtime-769', worker)
        self.assertIn('/static/styles.css?v=runtime-769', worker)
