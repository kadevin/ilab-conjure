    ...
    def test_create_app_keeps_public_route_surface(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            expected_surface = {
                ...
                ("/api/user-config-backups/summary", "GET"),
                ("/api/user-config-backups", "POST"),
                ("/api/user-config-backups/{job_id}", "GET"),
                ("/api/user-config-backups/{job_id}", "DELETE"),
                ("/api/user-config-backups/{job_id}/download", "GET"),
                ("/api/user-config-restores", "POST"),
                ("/api/user-config-restores/{session_id}/chunks", "PUT"),
                ("/api/user-config-restores/{session_id}", "GET"),
                ("/api/user-config-restores/{session_id}", "DELETE"),
                ("/api/user-config-restores/{session_id}/validate", "POST"),
                ("/api/user-config-restores/{session_id}/restore", "POST"),
